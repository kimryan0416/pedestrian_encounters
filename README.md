...
A script package for processing EEG data and Pose Data from VR. For direct use in the [Simspace Motion Capture Laboratory](https://geosimulation.org/).
...
Data samples can be identified in our Box Drive, accessible [here](https://nyu.box.com/s/igm1eshhcpply8k5woyfv0wabjjiwvww). If access is restricted, this is to prevent unwarranted usage of our datasets until they are publicized. You must request access by emailing the project lead, Ryan Kim [rk2546@nyu.edu](mailto:rk2546@nyu.edu).
